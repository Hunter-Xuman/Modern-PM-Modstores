...
- Download [Paper-Mario-3DS.unistore](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM4/Paper-Mario-3DS.unistore) and [Paper-Mario-3DS.t3x](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM4/Paper-Mario-3DS.t3x) from the PM4 source folder and place them in sdmc:/3ds/Universal-Updater/stores on your SD card.
...
- Download [wiiu_KEEPMAINAPPSTORE.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM5/wiiu_KEEPMAINAPPSTORE.zip) OR [wiiu_MODSTOREONLY.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM5/wiiu_MODSTOREONLY.zip) from the PM5 source folder and extract it to your SD card. The [wiiu_MODSTOREONLY.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM5/wiiu_MODSTOREONLY.zip) contains a new BGM.
...
- Download [switch_KEEPMAINAPPSTORE.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM62R/switch_KEEPMAINAPPSTORE.zip) OR [switch_MODSTOREONLY.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM62R/switch_MODSTOREONLY.zip) from the PM62R source folder and extract it to your SD card. The [switch_MODSTOREONLY.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM62R/switch_MODSTOREONLY.zip) contains a new BGM. (BGM Does Not Play In Applet Mode)
- The [switch_KEEPMAINAPPSTORE.zip](https://github.com/Hunter-Xuman/Modern-PM-Modstores/blob/main/PM62R/switch_KEEPMAINAPPSTORE.zip) also contains the repo for the HB App Store, so mods will show alongside homebrew apps. To help make it easier to find mods, they will be located in the Games section.
...
- [Disable Run Button](https://gamebanana.com/dl/1709330) by Darxoon
...
- [Paper Mario TTYD Retextured-Edition](https://gamebanana.com/mods/645769) by Nagisa/Panda
